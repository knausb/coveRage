...
The fastest option is probably [data.table::fread](http://cran.r-project.org/web/packages/data.table/index.html).
...
Another option is [readr](http://cran.r-project.org/web/packages/readr/index.html).
